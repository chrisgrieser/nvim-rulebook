...
M = {
	...
	javascript = {
		...
		docs = "https://prettier.io/docs/ignore.html#javascript",
	...
	css = {
		...
		location = "prevLine",
		ignoreRange = { "/* prettier-ignore-start */", "/* prettier-ignore-end */" },
		docs = "https://prettier.io/docs/ignore.html#css",
		formatterName = "prettier",
	},
	yaml = {
		ignoreBlock = "# prettier-ignore",
		location = "prevLine",
		ignoreRange = { "# prettier-ignore-start", "# prettier-ignore-end" },
		docs = "https://prettier.io/docs/ignore.html#yaml",
		formatterName = "prettier",
	},
	html = {
		ignoreBlock = "<!-- prettier-ignore -->",
		location = "prevLine",
		ignoreRange = { "<!-- prettier-ignore-start -->", "<!-- prettier-ignore-end -->" },
		docs = "https://prettier.io/docs/ignore.html#html",
		formatterName = "prettier",
	},
	markdown = {
		ignoreBlock = "<!-- prettier-ignore -->",
		location = "prevLine",
		ignoreRange = { "<!-- prettier-ignore-start -->", "<!-- prettier-ignore-end -->" },
		docs = "https://prettier.io/docs/ignore.html#markdown",
		formatterName = "prettier",
	},
	c = {
